...
var questions = [
    ...
    {
        "What self-titled album by an American Idol contestant including singles “It’s Not Over” and “Home” easily outsold the debut album of winner Taylor Hicks?": [
            "daughtry"
        ]
    },
    {
...
var CARD_TITLE = "Music Flash Cards";
...
function handleAnswerRequest(intent, session, callback) {
    ...
    if (!gameInProgress) {
        ...
        var speechOutput = "Your answer must be about a musician or related to music " + reprompt;
        ...
        if (currentQuestionIndex == GAME_LENGTH - 1) {
            ...
            speechOutput += speechOutputAnalysis + "You got " + currentScore.toString() + " out of "
                + GAME_LENGTH.toString() + " questions correct. Thank you for playing Music Trivia with Alexa!";
            callback(session.attributes,
...
function handleGetHelpRequest(intent, session, callback) {
    ...
    var speechOutput = "I will ask you to provide the answer to a variety of trivia questions about music. "
        + " To start a new game at any time, say, start new game. "
        + "To repeat the last question, say, repeat. "
        + "Would you like to keep playing?",
        repromptText = "To give an answer, respond with your answer. "
        + "Would you like to keep playing?";
...
function handleFinishSessionRequest(intent, session, callback) {
    ...
    callback(session.attributes,
        buildSpeechletResponseWithoutCard("Thanks for playing Music Flash Cards!", "", true));
}
